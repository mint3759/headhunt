...
urlpatterns = [
    ...
    url(r'^mypage/myrequest_client/(?P<pk>\d+)/$', views.myrequest_client, name='myrequest_client'),
    ...
    url(r'^mypage/completeAsk_content/(?P<pk>\d+)/$', views.completeAsk_content, name = 'completeAsk_content'),
    url(r'^mypage/accept_completeAsk/$', views.accept_completeAsk, name='accept_completeAsk'),
    url(r'^mypage/refuse_completeAsk/$', views.refuse_completeAsk, name='refuse_completeAsk'),
