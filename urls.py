...
urlpatterns = [
    ...
    url(r'^mypage/update_rating/$', views.update_rating, name='update_rating'),
    ...
    url(r'^mypage/cl_acc_request/$', views.cl_acc_request, name='cl_acc_request'),
    url(r'^mypage/accept_req_fromfree/$', views.accept_req_fromfree, name='accept_req_fromfree'),
    url(r'^mypage/update_freerating/$', views.update_freerating, name='update_freerating'),
